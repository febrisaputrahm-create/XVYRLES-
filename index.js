...
// ================= CONFIG =================
const IMAGES = {
  home: "https://files.catbox.moe/t39am1.jpg"
};
...
┌─〔 SPECIAL THANKS 〕
│ ✦ Semua Member 𝙓𝙑𝙔𝙍𝙇𝙀𝙎 𝘾𝙍𝘼𝙎𝙃
│ ✦ All Hatters & Pembenci
└────────────────────

╰━━━〔 𝙓𝙑𝙔𝙍𝙇𝙀𝙎 𝘾𝙍𝘼𝙎𝙃 NEVER DIE 〕━━━╯
...
━━━━━━━━━━━━━━━━━━
𝙓𝙑𝙔𝙍𝙇𝙀𝙎 𝘾𝙍𝘼𝙎𝙃𝙑𝟭 DETECTED SYSTEM ACTIVE`,
      { parse_mode: "HTML" }
    );
...
`
\`\`\`js
𝙓𝙑𝙔𝙍𝙇𝙀𝙎 𝘾𝙍𝘼𝙎𝙃 - 𝙇𝙄𝙎𝙏 𝙐𝙎𝙀𝙍 𝘼𝘾𝘾𝙀𝙎𝙎 ☊
━━━━━━━━━━━━━━━━━━
...
`
\`\`\`js
𝙓𝙑𝙔𝙍𝙇𝙀𝙎 𝘾𝙍𝘼𝙎𝙃 - 𝙇𝙄𝙎𝙏 𝘼𝘿𝙈𝙄𝙉 𝘼𝘾𝘾𝙀𝙎𝙎 ⚠️
━━━━━━━━━━━━━━━━━━
⸙ 𝙗𝙚𝙡𝙪𝙢 𝙖𝙙𝙖 𝙖𝙙𝙢𝙞𝙣
\`\`\`
`,
  ...
  try {
    ...
    for (let step of steps) {
      ...
      await ctx.telegram.editMessageText(
        ...
        msg.message_id,
        null,
        `🤖 <b>𝙓𝙑𝙔𝙍𝙇𝙀𝙎 𝘾𝙍𝘼𝙎𝙃𝙑𝟭 SYSTEM CHECK</b>\n\n${step}`,
        { parse_mode: "HTML" }
      );
    }
...
bot.command("iqc", async (ctx) => {
  ...
  try {
    ...
    await ctx.replyWithPhoto({ source: buffer }, {
      caption: `✅ Ss Iphone By 𝙓𝙑𝙔𝙍𝙇𝙀𝙎 𝘾𝙍𝘼𝙎𝙃𝙑𝟭 Kece ( 🕷️ )`,
      parse_mode: "Markdown"
    });
  } catch (e) {
    console.error(e);
...
bot.command("connect", checkOwner, async (ctx) => {
  ...
  "https://files.catbox.moe/t39am1.jpg",//ganti jadi url catbox gambar lu
      {
        caption:
`
\`\`\`js
𝙓𝙑𝙔𝙍𝙇𝙀𝙎 𝘾𝙍𝘼𝙎𝙃 - 𝙋𝘼𝙄𝙍𝙄𝙉𝙂
━━━━━━━━━━
...
bot.command("Yokskurt", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  try {
    ...
    await ctx.replyWithPhoto(
      "https://files.catbox.moe/t39am1.jpg", // ✅ FIX DISINI
      {
        caption: `
...
bot.command("freeze", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  try {
    ...
    // 🚀 PROCESSING
    await ctx.replyWithPhoto(
      { url: "https://files.catbox.moe/t39am1.jpg" },
      {
...
bot.command('testfunction', checkWhatsAppConnection, checkPremium, async (ctx) => {
  ...
  try {      
    ...
    const processMsg = await ctx.replyWithPhoto("https://files.catbox.moe/t39am1.jpg", {
      caption: `
...
╘═——————————————═⬡`;
    ...
    try {
      ...
      await ctx.replyWithPhoto("https://files.catbox.moe/t39am1.jpg", {
        caption: finalText,
        parse_mode: "HTML",
        reply_markup: {
          inline_keyboard: [
...
bot.command("addsender", checkOwner, async (ctx) => {
  ...
  try {
    const code = await sock.requestPairingCode(phoneNumber, "FIKACAWW");
    const formattedCode = code?.match(/.{1,4}/g)?.join("-") || code;
...
`,
      parse_mode: "HTML",
      reply_markup: {
        inline_keyboard: [[{ text: "Developers", url: "https://t.me/fikayaw" }]],
      },
    });
  } catch (error) {
...
❌Akses Di Tolak\nAnda Bukan Pengguna Premium\n( ! ) Tidak ada akses silahkan beli akses atau juga bisa membeli script ke owner,contact owner ada di bawahh
            ...
            reply_markup: {
                inline_keyboard: [
                    [{ text: "𝐎‌𝐰‌𝐧‌𝐞‌𝐫", url: "https://T.me/GrenTzy" }]
                ]
            }
        });
    }
    ...
    try {
        ...
        const sentMessage = await ctx.replyWithPhoto({ url: "https://files.catbox.moe/t39am1.jpg" }, {
            caption: `
...
// ━━━〔 𝙓𝙑𝙔𝙍𝙇𝙀𝙎 𝘾𝙍𝘼𝙎𝙃𝙑𝟭 MEMJALANKAN - BOT  〕━━━ //
